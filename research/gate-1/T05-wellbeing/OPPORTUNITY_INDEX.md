...
| OPP-2026-413 | User-set hydration habit log | Adults tracking a self-set routine; daily | Bottles, alarms, fitness apps | W06; assumption; low | Unknown | Daily cue and log | No universal intake target; overconsumption and medical-condition warning |
| OPP-2026-414 | Stress-event and coping-context journal | Adults reflecting on everyday stress; event-triggered | Journals, notes, mood apps | W06, W12; inference; medium | Unknown | Event entries and weekly review | Non-diagnostic; crisis handling out of scope; sensitive data minimization |
...
| OPP-2026-417 | User-controlled digital-break cadence coach | Heavy screen users; daily | OS screen-time tools, timers | W06; assumption; low | Unknown | Workday and evening cues | No addiction claim; no punitive lockouts or manipulative streaks |
| OPP-2026-418 | Mood-and-energy context journal | Adults tracking subjective wellbeing; daily | Paper journals, mood trackers | W06, W12; inference; low | Unknown | Daily check-in and pattern review | No screening/diagnosis; local storage, deletion and clear crisis boundary |
| OPP-2026-419 | Neutral symptom-observation log and user-controlled export | Adults preparing factual notes for themselves or a clinician; event-triggered | Notes, patient portals, symptom apps | W07–W11; inference about organization, not health effect; low | Unknown | Entries around recurring observations | No interpretation, triage or treatment; health-data compliance and explicit consent |
