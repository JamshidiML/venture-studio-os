...
This report documents seven unranked Qualified Gate 1 Candidates for small businesses and small teams. External Governance Correction Cycle 2 removed six concepts that lacked sufficient problem evidence; Cycle 3 moved seven guidance/category-led concepts to the [Hypothesis Watchlist](EXCLUSIONS.md#hypothesis-watchlist). The strongest direct problem evidence concerns invoice/payment administration. Direct but bounded survey or user evidence also covers supplier delays, quote/job splitting, scheduling friction, and field-photo synchronization. Official guidance establishes privacy, cybersecurity, employer-record, supplier-risk, and quality-documentation duties; those duties remain contextual or constraint evidence, not proof of user pain. Candidate-specific demand, pricing, and unit economics remain untested.
...
- Candidate count: seven qualified plus seven watchlist candidates within the 14-candidate Cycle-2 auditable universe; six earlier withdrawn concepts remain preserved in [EXCLUSIONS.md](EXCLUSIONS.md).
...
2. direct observed problem evidence or clearly adjacent observed workflow evidence that reasonably supports investigation of the bounded problem; category, duty, vendor, and current-alternative evidence cannot qualify a candidate by themselves;
...
Only the seven rows below are Qualified Gate 1 Candidates. The seven Cycle-3 watchlist records retain their complete Issue #10 contracts in [EXCLUSIONS.md](EXCLUSIONS.md#hypothesis-watchlist); they are not deleted, ranked, or qualified.
...
| Candidate | Cycle 3 status | Direct problem evidence | Context / population evidence | Current-alternative evidence | Technical feasibility evidence | Legal / privacy / safety / platform evidence | Unsupported assumption or hypothesis |
|---|---|---|---|---|---|---|---|
| OPP-2026-600 | Qualified | S07-02: invoicing/admin errors | S07-01 | S07-10 vendor invoicing feature | —; CSV/PDF path is inference | S07-03 to S07-06 controls | Exact preflight failure rate and WTP |
| OPP-2026-601 | Qualified | S07-02: payment delay and relationship restraint | S07-01 | S07-10 vendor reminder feature | —; CSV path is inference | Contact/privacy controls inferred from S07-05, S07-06 | Message effectiveness and WTP |
| OPP-2026-602 | Qualified | S07-17: user-reported quote/job splitting friction | S07-18 | S07-10, S07-17 field-service suite | —; import path is inference | Customer/site-data controls | Prevalence, severity, WTP |
| OPP-2026-604 | Qualified | S07-19: field-photo sync friction in one test | S07-18 | S07-10, S07-19 field-service suite | S07-19 demonstrates an incumbent path, not this wedge | Image/location privacy controls | Generalizability and WTP |
| OPP-2026-605 | Qualified | S07-17: scheduling/route limitations | S07-18 | S07-10, S07-17 field-service calendar | —; calendar import is inference | Consent/anti-spam boundary | Frequency, avoided capacity loss, WTP |
| OPP-2026-606 | Qualified | S07-17, S07-19: job forms/photo workflow observations | S07-18 | S07-10 to S07-12 | Incumbent paths exist; wedge feasibility untested | Image/site privacy; no certification | Unmet gap, packet frequency, WTP |
| OPP-2026-608 | Qualified | S07-15: directly reported supplier delays | S07-16 | Inbox/spreadsheet is assumption | —; CSV/forwarding path is inference | Supplier confidentiality | Discovery timing, severity, WTP |
| OPP-2026-609 | Hypothesis Watchlist | —; S07-16 is inventory-cost context only | S07-15, S07-16 | Whiteboard/spreadsheet is assumption | —; CSV path is inference | No autonomous purchasing | Approval-trail problem, frequency, WTP |
| OPP-2026-612 | Hypothesis Watchlist | —; S07-07, S07-08 establish duties | S07-07, S07-08 | S07-11 vendor training feature | —; calendar/file path is inference | Employment/eligibility boundary | Expiry pain, frequency, WTP |
| OPP-2026-613 | Hypothesis Watchlist | —; S07-09 establishes QMS category | S07-09 | S07-11, S07-12 vendor QMS features | —; CSV path is inference | Human quality authority | Action-loss frequency, WTP |
| OPP-2026-614 | Hypothesis Watchlist | —; S07-09 establishes audit category | S07-09 | S07-11, S07-12 vendor inspection features | —; file export is inference | No certification guarantee | Assembly burden, frequency, WTP |
| OPP-2026-617 | Hypothesis Watchlist | —; S07-05, S07-06 establish privacy duties | S07-05, S07-06 | Inbox/checklist is assumption | — | Direct legal/privacy constraint evidence S07-05, S07-06 | Workflow pain, frequency, WTP |
| OPP-2026-618 | Hypothesis Watchlist | —; S07-03, S07-04 establish security controls | S07-03, S07-04 | Spreadsheet/folder is assumption | — | Security/attestation constraints S07-03, S07-04, S07-06 | Rework frequency, WTP |
| OPP-2026-619 | Hypothesis Watchlist | —; S07-03, S07-04 establish access controls | S07-03, S07-04 | Manual checklist is assumption | — | Least-privilege controls S07-03, S07-04, S07-06 | Incompleteness rate, WTP |
...
Candidate diversity remains broad, but evidence quality now controls qualification. Six unsupported concepts were withdrawn rather than preserved for numerical symmetry. Of the 14-candidate Cycle-2 auditable universe, seven are qualified and seven guidance/category-led concepts are retained only in the Hypothesis Watchlist. The watchlist preserves supply/inventory, employer-record, quality, privacy, and security constraints and sales-route assumptions without presenting them as direct pain.
...
The first complete draft scored 88/100. Earlier Codex review sections are correctly labeled Internal Governance Simulation. External Governance Cycle 2 assigned the authoritative 95/100, resolved EXT-GOV-01, and opened completion finding EXT2-T07-01. Correction Cycle 3 preserves seven directly/adjacently observed workflows as qualified and moves seven guidance/category-led concepts to the watchlist. The Cycle-3 creator execution score is 100/100; no external score of 100 is claimed. See [QUALITY_SCORE_HISTORY.md](QUALITY_SCORE_HISTORY.md) and [CORRECTION_LOG.md](CORRECTION_LOG.md).

## Recommended next action

Keep Gate 1 open and do not rank, select, validate, or perform due diligence on a candidate.
